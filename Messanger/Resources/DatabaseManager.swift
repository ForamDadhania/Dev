...
extension DatabaseManager {
    ...
    ///creates a new conversation with target user and email and first message sent
...
//             update recipient conversation entry
            ...
            if var conversations = userNode["conversations"] as? [[String: Any]] {
                //conversation array exists for the current user
                //you should append
    ...
    private func finishCreatingConversation(name: String, converstionID: String, firstMessage: Message, completion: @escaping (Bool) -> Void) {
//            "id": String,
//            "type": text, photo, video,
//            "content": String,
//            "date": String,
...
//        print("adding covno: \(converstionID)")
//        print(converstionID)
        database.child("\(converstionID)").setValue(value, withCompletionBlock: { error, _ in
            guard error == nil else {
                completion(false)
                return
            }
    ...
    ///Fetches and returns all conversation for the user with the passed in email
    ...
    public func sendMessages(to conversation: String, otherUserEmail: String, name: String, newMessage: Message, completion: @escaping (Bool) -> Void) {
        ...
        database.child("\(conversation)/messages").observeSingleEvent(of: .value, with: { [weak self] snapshot in
            ...
            let newMessagesEntry: [String : Any] = [
            ...
            currentMessages.append(newMessagesEntry)
...
struct ChatAppUser {
    ...
    var profilePicturFileName: String {
        //patelforam11-gmail-com_profile_picture.png
